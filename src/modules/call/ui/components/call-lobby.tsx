...
export const CallLobby = ({onJoin}: Prop) =>{
    ...
    return (
        <div className="flex items-center justify-center h-full bg-radial from-sidebar-accent to-sidebar"> 
            <div className="py-4 px-8 flex items-center justify-center bg-red-500">
                <div className="p-4 flex flex-col items-center justify-center gap-y-6 bg-background rounded-lg">
